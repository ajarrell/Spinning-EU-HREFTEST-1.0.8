...
// Libs
import './theme/lib/slick';
import './theme/lib/match-height';

// Global
import './theme/custom/util';
import './theme/custom/header';
import './theme/custom/mega-menu-dropdown';
import './theme/custom/footer';
import './theme/custom/scroll-to';
import './theme/custom/tabbed-z';
import './theme/custom/long-tabs';

// Home
import './theme/custom/slider-with-feature';
import './theme/custom/explore';

// On load
window.onload = function () {
    setTimeout(() => {
        $('body').removeClass('windowIsLoading');
    }, 500);
};
...
const PageClasses = {
    mapping: {
        ...
        'pages/_subcategory': category,
        'pages/_category-apparel': category,
